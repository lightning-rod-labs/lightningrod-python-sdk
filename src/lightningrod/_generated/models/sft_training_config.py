...
T = TypeVar("T", bound="SFTTrainingConfig")
...
class SFTTrainingConfig:
    ...
    Attributes:
        ...
        training_type (Literal['SFT'] | Unset):  Default: 'SFT'.
    ...
    base_model_id: str
    training_steps: int
    training_type: Literal["SFT"] | Unset = "SFT"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        training_type = cast(Literal["SFT"] | Unset, d.pop("training_type", UNSET))
        if training_type != "SFT" and not isinstance(training_type, Unset):
            raise ValueError(f"training_type must match const 'SFT', got '{training_type}'")
        ...
        sft_training_config.additional_properties = d
        return sft_training_config
