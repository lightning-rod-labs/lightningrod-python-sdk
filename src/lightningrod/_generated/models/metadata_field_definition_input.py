...
T = TypeVar("T", bound="MetadataFieldDefinitionInput")


@_attrs_define
class MetadataFieldDefinitionInput:
    """Definition of a metadata field for a FileSet (input/request version).

    Attributes:
        name (str): The name/key of the metadata field
        field_type (MetadataFieldType):
        required (bool): Whether this field is required for all files
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata_field_definition_input = cls(
            name=name,
            field_type=field_type,
            required=required,
        ...
        metadata_field_definition_input.additional_properties = d
        return metadata_field_definition_input
