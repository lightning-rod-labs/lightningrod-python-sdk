...
class MultipleChoiceAnswerType:
    ...
    Attributes:
        ...
        question_generation_instruction (str | Unset): Instructions for generating questions of this type. Default:
            ...
            that differ only by vague or qualitative wording (e.g., 'significant', 'major', 'substantial')\n- Context-
            dependent references (e.g., 'the country', 'the leader', 'later this year')\n- Options that combine multiple
            events, conditions, or contingencies".
